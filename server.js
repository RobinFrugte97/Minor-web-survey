...
app
    ...
    .get("/vraag1", (req, res) => {res.render('questions/vraag1.ejs', { studentnummer })})
    .get("/vraag2", (req, res) => {res.render('questions/vraag2.ejs', { studentnummer })})
    .get("/vraag3", (req, res) => {res.render('questions/vraag3.ejs', { studentnummer })})
    .get("/vraag4", (req, res) => {res.render('questions/vraag4.ejs', { studentnummer })})
    .get("/vraag5", (req, res) => {res.render('questions/vraag5.ejs', { studentnummer })})
    .get("/vraag6", (req, res) => {res.render('questions/vraag6.ejs', { studentnummer })})
    .get("/vraag7", (req, res) => {res.render('questions/vraag7.ejs', { studentnummer })})
    .get("/vraag8", (req, res) => {res.render('questions/vraag8.ejs', { studentnummer })})
    .get("/vraag9", (req, res) => {res.render('questions/vraag9.ejs', { studentnummer })})
    .get("/vraag10", (req, res) => {res.render('questions/vraag10.ejs', { studentnummer })})
    .get("/vraag11", (req, res) => {res.render('questions/vraag11.ejs', { studentnummer })})
    .get("/vraag12", (req, res) => {res.render('questions/vraag12.ejs', { studentnummer })})
    .get("/vraag13", (req, res) => {res.render('questions/vraag13.ejs', { studentnummer })})
    .get("/vraag14", (req, res) => {res.render('questions/vraag14.ejs', { studentnummer })})
    .get("/vraag15", (req, res) => {res.render('questions/vraag15.ejs', { studentnummer })})
    .get("/vraag16", (req, res) => {res.render('questions/vraag16.ejs', { studentnummer })})
    .get("/vraag17", (req, res) => {res.render('questions/vraag17.ejs', { studentnummer })})
    .get("/vraag18", (req, res) => {res.render('questions/vraag18.ejs', { studentnummer })})
    .get("/vraag19", (req, res) => {res.render('questions/vraag19.ejs', { studentnummer })})
    .get("/vraag20", (req, res) => {res.render('questions/vraag20.ejs', { studentnummer })})
